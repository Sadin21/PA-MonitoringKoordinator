...
@section('title', 'Beasiswa | Dashboard Anak Asuh')
@section('content')
<div>
    <section class="w-full bg-white border-2 shadow-sm p-10 rounded-md">
        <h1 class="text-2xl font-semibold">Informasi Laporan Beasiswa</h1>
        <p>Perbarui akun dan data dirimu</p>
        <div class="flex gap-4">
            <a  href="{{ route('child.create-beasiswa') }}" type="button" class="py-2 w-40 bg-[#006934] text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg mt-10">
                Buat Laporan
            </a>
        </div>
    </section>
                      ...
                      <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <a href="#" class="relative block">
                                <img src="{{ url("{$d->file}") }}" class="mx-auto object-cover border-4 rounded-sm h-24 w-28 "/>
                            </a>
                        </div>
                      </div>
                  </td>
