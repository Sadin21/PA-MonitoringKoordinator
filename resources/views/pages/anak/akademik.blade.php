...
@section('title', 'Akademik | Dashboard Anak Asuh')
@section('content')
<div>
    <section class="w-full bg-white border-2 shadow-sm p-10 rounded-md">
        <h1 class="text-2xl font-semibold">Informasi Laporan Akademik</h1>
        <p>Perbarui akun dan data dirimu</p>
        <div class="flex gap-4">
            <a  href="{{ route('child.create-akademik') }}" type="button" class="py-2 w-40 bg-[#006934] text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg mt-10">
                Buat Laporan
            </a>
        </div>
    </section>
