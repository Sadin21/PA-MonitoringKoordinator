...
<div>
    <section class="w-full bg-white border-2 shadow-sm p-10 rounded-md">
        ...
        <form class="mt-10" action="{{ route('child.update-child', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-2 gap-8">
                <div>
                    ...
                    <div class=" relative pb-4">
                        ...
                        class="rounded-lg border-1 flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="gender">
                            ...
                            <option value="Laki - laki" {{ old('name', $data->name) == 'Laki - laki' ? 'selected' : '' }}>Laki - laki</option>
                ...
                <div class="">
                    ...
                    <div class=" relative pb-4">
                        <input type="text" name="class" class=" rounded-lg border-1 flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Kelas"  value={{ old('class', $data->class) }}>
                        @error('class')
                        <div class="bg-red-200 border-red-600 text-red-600 border-l-4 p-4" role="alert">
                            <p>
                                {{ $message }}
                    ...
                    <div class=" relative pb-4">
                        <input type="text" name="semester" class=" rounded-lg border-1 flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Sekolah"  value={{ old('semester', $data->semester) }}>
                        @error('semester')
                        <div class="bg-red-200 border-red-600 text-red-600 border-l-4 p-4" role="alert">
                            <p>
                                {{ $message }}
