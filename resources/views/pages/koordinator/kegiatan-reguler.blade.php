...
@section('title', 'Kegiatan Reguler | Dashboard Koordinator')
@section('content')
<section class="w-full bg-white border-2 shadow-sm p-10 rounded-md">
    <h1 class="text-2xl font-semibold">Update Laporan Kegiatan (Reguler)</h1>
