...
@section('title', 'Create Wali | Dashboard Koordinator')
@section('content')
<div>
    <section class="w-full bg-white border-2 shadow-sm p-10 rounded-md">
        ...
        <form action="{{ route('koordinator.store-data-wali') }}" method="POST" class="container bg-white w-full grid grid-cols-2 gap-8 mt-10"  enctype="multipart/form-data">
            @csrf
            <div>
