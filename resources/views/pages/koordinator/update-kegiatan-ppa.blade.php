...
<section class="w-full bg-white border-2 shadow-sm p-10 rounded-md">
    <h1 class="text-2xl font-semibold">Laporan Kegiatan Anak Asuh PPA</h1>
    <p>Perbarui data</p>
</section>
<section class="grid grid-cols-5 gap-8 mt-10">
    ...
    <div class="col-span-4">
        ...
        <div class="border-2 bg-white p-4 mt-8">
            <form action="{{ route('koordinator.update-kegiatan-ppa', $data->first()->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
